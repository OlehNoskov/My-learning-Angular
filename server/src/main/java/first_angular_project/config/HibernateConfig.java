package first_angular_project.config;
...
@EnableJpaRepositories("first_angular_project.persistence.repository")
public class HibernateConfig {
    ...
    private static final String ENTITY_MANAGER_PACKAGES_TO_SCAN = "first_angular_project.persistence.entity";
